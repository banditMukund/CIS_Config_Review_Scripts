...
Write-Output '====';
$testcase = "18.6.4.1 (L1) Ensure 'Configure DNS over HTTPS (DoH) name resolution' is set to 'Enabled: Allow DoH' or higher"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient' -Name 'DoHPolicy';
Write-Output '====';
$testcase = "18.6.4.2 (L1) Ensure 'Configure NetBIOS settings' is set to 'Enabled: Disable NetBIOS name resolution on public networks"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\Software\Policies\Microsoft\Windows NT\DNSClient' -Name 'EnableNetbios';
Write-Output '====';
$testcase = "18.6.4.3 (L1) Ensure 'Turn off multicast name resolution' is set to 'Enabled'"
Write-Output "$testcase"
