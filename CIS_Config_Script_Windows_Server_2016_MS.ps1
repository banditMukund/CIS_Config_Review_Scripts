...
Write-Output '====';
$testcase = "1.1.1 Ensure 'Enforce password history' is set to '24 or more password(s)'"
Write-Output "$testcase"
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'PasswordHistorySize =';
Write-Output '====';
$testcase = "1.1.2 Ensure 'Maximum password age' is set to '365 or fewer days, but not 0'"
Write-Output "$testcase"
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'MaximumPasswordAge =';
Write-Output '====';
$testcase = "1.1.3 Ensure 'Minimum password age' is set to '1 or more day(s)'"
Write-Output "$testcase"
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'MinimumPasswordAge =';
Write-Output '====';
$testcase = "1.1.4 Ensure 'Minimum password length' is set to '14 or more character(s)'"
Write-Output "$testcase"
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'MinimumPasswordLength =';
Write-Output '====';
$testcase = "1.1.5 Ensure 'Password must meet complexity requirements' is set to 'Enabled'"
Write-Output "$testcase"
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'PasswordComplexity =';
Write-Output '====';
$testcase = "1.1.6 Ensure 'Store passwords using reversible encryption' is set to 'Disabled'"
Write-Output "$testcase"
...
Write-Output '====';
$testcase = "18.3.1 (L1) Ensure LAPS AdmPwd GPO Extension / CSE is installed (MS only)"
Write-Output "$testcase"
...
Write-Output '====';
$testcase = "18.3.2 (L1) Ensure 'Do not allow password expiration time longer than required by policy' is set to 'Enabled' (MS only)"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd' -Name 'PwdExpirationProtectionEnabled';
Write-Output '====';
$testcase = "18.3.3 (L1) Ensure 'Enable Local Admin Password Management' is set to 'Enabled' (MS only)"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\Software\Policies\Microsoft Services\AdmPwd' -Name 'AdmPwdEnabled';
Write-Output '====';
$testcase = "18.3.4 (L1) Ensure 'Password Settings: Password Complexity' is set to 'Enabled: Large letters + small letters + numbers + special characters' (MS only)"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd' -Name 'PasswordComplexity';
Write-Output '====';
$testcase = "18.3.5 (L1) Ensure 'Password Settings: Password Length' is set to 'Enabled: 15 or more' (MS only)"
Write-Output "$testcase"
Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd' -Name 'PasswordLength';
Write-Output '====';
$testcase = "18.3.6 (L1) Ensure 'Password Settings: Password Age (Days)' is set to 'Enabled: 30 or fewer' (MS only)"
Write-Output "$testcase"
